...
const getTableType = async (id: number): Promise<TableTypeResponse> => {
    const response = await apiClient.get<BaseResponse<TableTypeResponse>>(
        `/table-types/${id}`
    );
    return response.data.payload!;
...
export const validateTableTypeData = (
    ...
    if (
        ...
        errors.depositForBooking =
            'Deposit must be between 0 and 999,999,999.99';
    }
...
export const defaultTableTypes = [
    ...
    },
    {
        ...
        color: '#8B5CF6',
        icon: 'Lock',
        depositForBooking: 50000,
    },
    {
        tableType: 'COUPLE',
        color: '#F472B6',
        icon: 'Heart',
        depositForBooking: 30000,
    },
    {
        tableType: 'FAMILY',
        color: '#10B981',
        icon: 'Users',
        depositForBooking: 20000,
    },
    {
        tableType: 'BUSINESS',
        color: '#3B82F6',
        icon: 'Briefcase',
        depositForBooking: 25000,
    },
    {
        tableType: 'SMOKING',
        color: '#EF4444',
    ...
    {
        tableType: 'NON_SMOKING',
        color: '#6B7280',
        icon: 'Ban',
        depositForBooking: 0,
    },
    {
        tableType: 'WHEELCHAIR_ACCESSIBLE',
        color: '#14B8A6',
        icon: 'Accessibility',
        depositForBooking: 0,
    },
