        ...
        <div className="container mx-auto py-8 px-4">
            <div className="mb-8 text-center">
                ...
                <p className="text-muted-foreground max-w-2xl mx-auto">
                    We value your feedback! Tell us about your overall dining
                    experience at Menu+. Your insights help us improve our
                    service and create better experiences for all our guests.
                </p>
            </div>
