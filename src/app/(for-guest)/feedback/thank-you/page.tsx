          ...
          <CardContent className="space-y-6">
            <div className="text-center space-y-4">
              <p className="text-gray-700">
                ...
                Your insights help us continuously improve our service and create better 
                dining experiences for all our guests.
              </p>
              ...
              <div className="bg-white p-4 rounded-lg border border-green-200">
                ...
                <ul className="text-sm text-gray-600 space-y-1 text-left">
                  ...
                  <li>• If you provided contact information, we may reach out to you</li>
                  <li>• Your feedback will help us improve our services</li>
            ...
            <div className="text-sm text-gray-500 pt-4 border-t border-green-200">
              <p>
                Have questions about your feedback? Contact us at{' '}
                <a href="mailto:feedback@menuplus.com" className="text-green-600 hover:underline">
