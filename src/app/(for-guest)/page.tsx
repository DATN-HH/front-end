      ...
      <section className="relative h-screen flex items-center justify-center">
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl mb-8 text-gray-200 leading-relaxed">
            Where artistry meets flavor in an unforgettable dining experience.
            Discover the finest ingredients, masterful techniques, and
            impeccable service.
          </p>
        ...
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Every detail is carefully orchestrated to create moments that
              transcend ordinary dining
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            <div className="text-center">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Our master chefs transform the finest ingredients into edible
                masterpieces, each dish telling a story of passion and
                precision.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Our dedicated team anticipates your every need, ensuring a
                seamless and memorable dining experience from arrival to
                departure.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Sophisticated interiors and intimate lighting create the perfect
                backdrop for celebrations, business dinners, and romantic
                evenings.
              </p>
            </div>
          </div>
      ...
      <section className="py-20 px-4 bg-gray-50">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Discover the dishes that have earned us acclaim from critics and
              diners alike
            </p>
          </div>
            ...
            {[
              {
                ...
                image:
                  'https://uglyfood.com.sg/wp-content/uploads/2024/11/lobster-thermidor-recipe-1730865246.jpg',
              ...
              },
              {
                ...
                image:
                  'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTEk72XriR3m9-CE09mElnt3ts9ggvvCQBwmQ&s',
              ...
              },
              {
                ...
                image:
                  'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRr2SEjf8FhEuwYziBDDjadL9rLPjhf1aTJ8w&s',
        ...
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">
              Experience Menu+ at our carefully selected venues across the
              nation
            </p>
          </div>
            ...
            {[
              {
                ...
                phone: '(212) 554-1515',
                image:
                  'https://cdn.vox-cdn.com/thumbor/5KW6LyvRoAlyD2Sg4tgV8PHGTLs=/0x0:8000x6000/1200x800/filters:focal(3360x2360:4640x3640)/cdn.vox-cdn.com/uploads/chorus_image/image/73722929/NYC_STORE_VISUAL_STELLAR_4000x_DSCF3644_R1.0.jpg',
              },
              {
                city: 'San Francisco',
                ...
                phone: '(415) 282-8283',
                image:
                  'https://www.6newyork.fr/wp-content/uploads/2022/02/restaurant-6-newyork-paris.jpg',
              },
              {
                city: 'Beverly Hills',
                ...
                phone: '(310) 555-0199',
                image:
                  'https://image-tc.galaxy.tf/wijpeg-41asktw6ctetbsko5nahsw0wx/murals-restaurant-new-york_wide.jpg?crop=0%2C44%2C1917%2C1078',
              },
              {
                city: 'Chicago',
                ...
                phone: '(312) 555-0145',
                image:
                  'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSy3VB8tClrGSHaZ9o8ilo_lBXMq4f_q2ClVQ&s',
              },
            ].map((location, index) => (
              <Card
                key={index}
      ...
      <section className="py-20 px-4 bg-gray-900 text-white">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Reserve your table today and discover why Menu+ is the destination
