...
export default function NewPosCategoryPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    router.push("/dashboard/menu/pos-categories")
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center space-x-4">
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Create New POS Category</h1>
          <p className="text-muted-foreground">Add a new category to organize products on POS</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Enter basic POS category information</CardDescription>
          </CardHeader>
