...
export default function PosCategoriesPage() {
  ...
  const paginatedCategories = filteredAndSortedCategories.slice(startIndex, startIndex + itemsPerPage)
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">Manage product categories displayed on Point of Sale</p>
        </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Showing {startIndex + 1}-{Math.min(startIndex + itemsPerPage, filteredAndSortedCategories.length)}
                  ...
                  <div className="p-2 space-y-2">
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value) => setFilters({ ...filters, parentCategory: value })}
                      >
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="Main Course">Children of Main Course</SelectItem>
                          <SelectItem value="Beverages">Children of Beverages</SelectItem>
                        </SelectContent>
                      </Select>
                    </div>
                  </div>
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead>
                  <Button variant="ghost" onClick={() => handleSort("sequence")} className="h-auto p-0 font-semibold">
                    Sequence
              ...
              {paginatedCategories.map((category) => (
                <TableRow key={category.id}>
                  <TableCell className="font-medium">
                    {category.parentCategory && <span className="text-gray-400 mr-2">└─</span>}
                    {category.name}
                  </TableCell>
                  ...
                  <TableCell className="text-right">
                    <div className="flex items-center justify-end space-x-2">
                                                  <Link href={`/dashboard/menu/pos-categories/${category.id}/detail`}>
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          <DropdownMenuItem onClick={() => handleMoveUp(category.id, category.name)}>
                            <ArrowUp className="mr-2 h-4 w-4" />
                            Move Up
                          </DropdownMenuItem>
                          <DropdownMenuItem onClick={() => handleMoveDown(category.id, category.name)}>
      ...
      <PosCategoryModal open={showCategoryModal} onOpenChange={setShowCategoryModal} />
