...
export default function ProductsPage() {
  ...
  const filteredAndSortedProducts = useMemo(() => {
    const filtered = allProducts.filter((product) => {
      ...
      const matchesActive = filters.active === "all" || product.active.toString() === filters.active
      const matchesPos =
        filters.availableInPos === "all" || product.availableInPos.toString() === filters.availableInPos

      return matchesSearch && matchesType && matchesCategory && matchesActive && matchesPos
    })
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Showing {startIndex + 1}-{Math.min(startIndex + itemsPerPage, filteredAndSortedProducts.length)}
                    ...
                    <div className="flex items-center justify-end space-x-2">
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          <DropdownMenuItem onClick={() => handleArchive(product.id, product.name)}>
