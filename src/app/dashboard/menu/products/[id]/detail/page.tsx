      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Product details and configuration</p>
          </div>
        </div>
        ...
        <TabsContent value="general" className="space-y-4">
          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div>
                <label className="text-sm font-medium text-gray-500">Can be sold</label>
                <Badge variant={product.canBeSold ? "default" : "secondary"}>
                  {product.canBeSold ? "Yes" : "No"}
                </Badge>
              </div>
              <div>
                <label className="text-sm font-medium text-gray-500">Can be purchased</label>
        ...
        <TabsContent value="variants" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>List of variants for this product</CardDescription>
            </CardHeader>
            <CardContent>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-sm">Ordered quantities</p>
                  </div>
                  <div>
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="text-sm font-medium text-gray-500">Track Inventory</label>
                    <Badge variant="secondary">{product.type === "Stockable" ? "Yes" : "No"}</Badge>
                  </div>
                </div>
              </div>
            </CardContent>
