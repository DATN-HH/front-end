...
const allAttributes = [
  ...
  },
  {
    ...
    creationMode: "Dynamically",
    valueCount: 8,
    values: ["Beef", "Pork", "Chicken", "Shrimp", "Mushroom", "Vegetables", "Cheese", "Egg"],
...
export default function AttributesPage() {
  ...
  const filteredAndSortedAttributes = useMemo(() => {
    const filtered = allAttributes.filter((attribute) => {
      ...
      const matchesDisplayType = filters.displayType === "all" || attribute.displayType === filters.displayType
      const matchesCreationMode = filters.creationMode === "all" || attribute.creationMode === filters.creationMode
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">Manage attributes to create product variants</p>
        </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Showing {startIndex + 1}-{Math.min(startIndex + itemsPerPage, filteredAndSortedAttributes.length)}
                  ...
                  <div className="p-2 space-y-2">
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value) => setFilters({ ...filters, displayType: value })}
                      >
                    ...
                    <div>
                      ...
                      <Select
                        ...
                        onValueChange={(value) => setFilters({ ...filters, creationMode: value })}
                      >
                        <SelectTrigger className="w-full">
                          <SelectValue placeholder="All" />
                        </SelectTrigger>
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead>
                  <Button variant="ghost" onClick={() => handleSort("valueCount")} className="h-auto p-0 font-semibold">
                    Value Count
            ...
            <TableBody>
              {paginatedAttributes.map((attribute) => (
                <TableRow key={attribute.id}>
                  ...
                  <TableCell>{attribute.valueCount}</TableCell>
                  <TableCell>
                  ...
                  <TableCell className="text-right">
                    <div className="flex items-center justify-end space-x-2">
                                                  <Link href={`/dashboard/menu/attributes/${attribute.id}/detail`}>
      ...
      <AttributeModal open={showAttributeModal} onOpenChange={setShowAttributeModal} />
      <AttributeEditModal 
        open={showEditModal} 
