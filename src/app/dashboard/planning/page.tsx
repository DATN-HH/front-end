...
import { Clock, UserCog, Users, FileText, Bell, ArrowLeft } from 'lucide-react';
    ...
    <div className="flex flex-col gap-6">
      <div className="flex items-center gap-4">
        ...
        <div className="flex flex-col gap-2">
          <h1 className="text-3xl font-bold tracking-tight">Planning Module</h1>
          <p className="text-muted-foreground">
            Personnel Management and Scheduling System
          </p>
        </div>
      </div>
