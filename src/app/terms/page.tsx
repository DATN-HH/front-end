    ...
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-serif font-semibold mb-4">Reservation Policy</h2>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            We maintain a smart casual to business formal dress code. We reserve the right to refuse service to guests
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 mb-4">
            ...
            <li>For parties of 6 or more, an 18% service charge will be added</li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mb-4">
            Menu+ Fine Dining is not responsible for lost or stolen items. Please inform us of any food allergies or
