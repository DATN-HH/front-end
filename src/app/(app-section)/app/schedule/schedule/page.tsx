...
function SchedulePage() {
    ...
    const { data: activeLockToday } = useActiveScheduleLock(
        branchId!,
        todayDate
    );
                    ...
                    <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent>
                                ...
                                <DropdownMenuItem
                                    onClick={() => setIsCopyOpenShiftOpen(true)}
                                >
                                    Copy Open Shift
                                </DropdownMenuItem>
                                <DropdownMenuItem
                                    onClick={() =>
                                        setIsCopyWeekWithScheduleOpen(true)
                                    }
                                >
                                    Copy Schedule
                                </DropdownMenuItem>
                                <DropdownMenuItem
                                    onClick={() =>
                                        setIsShiftSuggestionsOpen(true)
                                    }
                                >
                                    Suggestions
                                </DropdownMenuItem>
                        ...
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent>
                                <DropdownMenuItem
                                    onClick={() =>
                                        router.push(
                                            '/app/settings/schedule-configuration'
                                        )
                                    }
                                >
                                    Configuration
                                ...
                                <DropdownMenuItem
                                    onClick={() =>
                                        setIsScheduleLockManagerOpen(true)
                                    }
                                >
                                    Lock Manager
                                </DropdownMenuItem>
                        ...
                        <AlertDescription className="text-red-800">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    - Locked by {activeLockToday.lockedByName}{' '}
                                    on{' '}
                                    {format(
                            ...
                            <AlertDescription className="text-orange-800">
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        - Locked by{' '}
                                        {activeLockSelected.lockedByName} on{' '}
                                        {format(
                                            new Date(
                                                activeLockSelected.lockedAt
                                            ),
                                            'MMM dd, yyyy HH:mm'
                                        )}
