...
export function ScheduleOverview() {
            ...
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xl lg:text-2xl font-bold">
                  {data.staffShiftStats.totalStaffShifts || 0}
                </p>
        ...
        <Card>
          <CardContent className="p-4 lg:p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xl lg:text-2xl font-bold">
                  {data.staffWorkingStats.workingStaff
                    .reduce(
                      (total, staff) => total + (staff.totalWorkingHours || 0),
                      0
                    )
                    .toFixed(1)}
                </p>
        ...
        <Card>
          <CardContent className="p-4 lg:p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xl lg:text-2xl font-bold">
                  {data.staffWorkingStats.totalActiveStaff || 0}
                </p>
        ...
        <Card>
          <CardContent className="p-4 lg:p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xl lg:text-2xl font-bold">
                  {data.shiftLeaveStats.pendingRequests || 0}
                </p>
                <p className="text-xs text-muted-foreground">
                  Pending Shift Leaves
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3 lg:gap-4">
                <div className="bg-blue-50 p-3 rounded-lg text-center">
                  <div className="text-xl lg:text-2xl font-bold text-blue-600">
                    {data.staffShiftStats.publishedShifts || 0}
                  </div>
                ...
                <div className="bg-yellow-50 p-3 rounded-lg text-center">
                  <div className="text-xl lg:text-2xl font-bold text-yellow-600">
                    {data.staffShiftStats.pendingShifts || 0}
                  </div>
              ...
              <div className="pt-2 border-t">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">
                    {Math.round(
                      ((data.staffShiftStats.publishedShifts || 0) /
                        (data.staffShiftStats.totalStaffShifts || 1)) *
                        100
                    )}
                    %
                  </span>
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-3 lg:gap-4">
                <div className="bg-green-50 p-3 rounded-lg text-center">
                  <div className="text-xl lg:text-2xl font-bold text-green-600">
                    {data.shiftLeaveStats.approvedRequests || 0}
                  </div>
                ...
                <div className="bg-red-50 p-3 rounded-lg text-center">
                  <div className="text-xl lg:text-2xl font-bold text-red-600">
                    {data.shiftLeaveStats.rejectedRequests || 0}
                  </div>
                  <div className="text-xs text-red-600 font-medium">
                    Rejected
                  </div>
                ...
                <div className="bg-gray-50 p-3 rounded-lg text-center">
                  <div className="text-xl lg:text-2xl font-bold text-gray-600">
                    {data.shiftLeaveStats.cancelledRequests || 0}
                  </div>
              ...
              <div className="space-y-2 pt-2 border-t">
                <div className="flex justify-between">
                  <span className="text-sm text-muted-foreground">
                    Total Affected Shifts
                  </span>
                  <span className="font-medium">
                    {data.shiftLeaveStats.totalAffectedShifts || 0}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm text-muted-foreground">
                  ...
                  <span className="font-medium">
                    {(data.shiftLeaveStats.averageAffectedShifts || 0).toFixed(
                      1
                    )}
                  </span>
                </div>
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="grid grid-cols-1 gap-3 lg:gap-4">
                <div className="bg-blue-50 p-3 rounded-lg text-center">
                  <div className="text-xl lg:text-2xl font-bold text-blue-600">
                    {data.shiftLeaveStats.totalEmployeesWithBalance || 0}
                  </div>
                  <div className="text-xs text-blue-600 font-medium">
                ...
                <div className="bg-purple-50 p-3 rounded-lg text-center">
                  <div className="text-xl lg:text-2xl font-bold text-purple-600">
                    {(data.shiftLeaveStats.averageShiftBalance || 0).toFixed(1)}
                  </div>
              ...
              <div className="space-y-2 pt-2 border-t">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">
                    {data.shiftLeaveStats.totalShiftsUsed || 0}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm text-muted-foreground">
                  ...
                  <span className="font-medium">
                    {data.shiftLeaveStats.totalShiftsAvailable || 0}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm text-muted-foreground">
                  ...
                  <span className="font-medium">
                    {Math.round(
                      ((data.shiftLeaveStats.totalShiftsUsed || 0) /
                        (data.shiftLeaveStats.totalShiftsAvailable || 1)) *
                        100
                    )}
                    %
                  </span>
  ...
  const renderUnderStaffedShifts = () => {
    ...
    if (!data || data.underStaffedShifts.totalUnderStaffedShifts === 0)
      return null;
    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {data.underStaffedShifts.totalUnderStaffedShifts} shifts need
            additional staff
          </CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <div className="space-y-3 max-h-64 overflow-y-auto">
              ...
              {data.staffWorkingStats.workingStaff.length > 10 && (
                <p className="text-sm text-muted-foreground text-center">
                  and {data.staffWorkingStats.workingStaff.length - 10} more
                  staff...
                </p>
              )}
            </div>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-base lg:text-lg">
                ...
                {data.staffWorkingStats.staffWithoutShifts})
              </CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-3 max-h-64 overflow-y-auto">
                {data.staffWorkingStats.nonWorkingStaff
                  .slice(0, 10)
                  .map((staff) => (
                    <div
                      key={staff.staffId}
                ...
                {data.staffWorkingStats.nonWorkingStaff.length > 10 && (
                  <p className="text-sm text-muted-foreground text-center">
                    and {data.staffWorkingStats.nonWorkingStaff.length - 10}{' '}
                    more staff...
                  </p>
                )}
              </div>
