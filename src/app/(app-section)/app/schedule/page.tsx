                ...
                <Card>
                    <CardContent className="p-4 lg:p-6">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-xl lg:text-2xl font-bold">
                                    {data.staffWorkingStats.totalActiveStaff ||
                                        0}
                                </p>
                                <p className="text-xs text-muted-foreground">
                                    Active Staff
                            ...
                            <div className="grid grid-cols-2 gap-3 lg:gap-4">
                                <div className="bg-blue-50 p-3 rounded-lg text-center">
                                    <div className="text-xl lg:text-2xl font-bold text-blue-600">
                                        {data.staffShiftStats.publishedShifts ||
                                            0}
                                    </div>
                                ...
                                <div className="bg-yellow-50 p-3 rounded-lg text-center">
                                    <div className="text-xl lg:text-2xl font-bold text-yellow-600">
                                        {data.staffShiftStats.pendingShifts ||
                                            0}
                                    </div>
                    ...
                    <CardContent>
                        <div className="space-y-4">
                            <div className="grid grid-cols-2 gap-3 lg:gap-4">
                                ...
                                <div className="bg-yellow-50 p-3 rounded-lg text-center">
                                    <div className="text-xl lg:text-2xl font-bold text-yellow-600">
                                        {data.shiftLeaveStats.pendingRequests ||
                                            0}
                                    </div>
                                    <div className="text-xs text-yellow-600 font-medium">
                                        Pending
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2 pt-2 border-t">
                                <div className="flex justify-between">
                                    ...
                                    <span className="font-medium">
                                        {data.shiftLeaveStats.totalShiftsUsed ||
                                            0}
                                    </span>
                                </div>
                                <div className="flex justify-between">
        ...
        return (
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        {data.underStaffedShifts.totalUnderStaffedShifts} shifts
                ...
                <Card>
                    <CardHeader>
                        <CardTitle className="flex items-center gap-2 text-base lg:text-lg">
                            ...
                            Staff with Shifts (
                            {data.staffWorkingStats.staffWithShifts})
                        </CardTitle>
                    </CardHeader>
                    <CardContent>
                        <div className="space-y-3 max-h-64 overflow-y-auto">
                            ...
                            {data.staffWorkingStats.workingStaff.length >
                                10 && (
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="space-y-3 max-h-64 overflow-y-auto">
                                ...
                                {data.staffWorkingStats.nonWorkingStaff.length >
                                    10 && (
                                    <p className="text-sm text-muted-foreground text-center">
                                        and{' '}
                                        {data.staffWorkingStats.nonWorkingStaff
            ...
            <PageTitle
                ...
                left={
                    <div className="text-muted-foreground text-sm lg:text-base">
                        {data &&
                            `${data.branchName} • ${data.startDate} - ${data.endDate}`}
                    </div>
                }
            />
