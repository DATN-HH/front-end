        ...
        <div className="space-y-6">
                ...
                <Card>
                    ...
                    <CardContent className="space-y-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm">
                                {sampleProduct.internalReference}
                            </p>
                        </div>
                        <div className="flex gap-2">
                            <Badge
                                variant={
                                    sampleProduct.canBeSold
                                        ? 'default'
                                        : 'secondary'
                                }
                            >
                ...
                <Card>
                    <CardHeader>
                        <CardTitle className="flex items-center justify-between">
                            ...
                            <Button
                                size="sm"
                                onClick={() => setShowAttributeEdit(true)}
                            >
                                <Edit className="h-4 w-4 mr-1" />
                                Edit
                            </Button>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Instructions for implementing edit modals in your
                        components
                    </CardDescription>
                </CardHeader>
