            ...
            {!isDeleted && (
              <>
                ...
                <Button
                  ...
                  onClick={() =>
                    handleDeleteValue(row.original.id, row.original.name)
                  }
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-500">Attribute values</p>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-primary">
                    {attributeValues.reduce(
                      (sum, value) => sum + (value.usageCount || 0),
                      0
                    )}
                  </div>
                  <p className="text-sm text-gray-500">Total usage count</p>
                </div>
              </CardContent>
            </Card>
          </div>
