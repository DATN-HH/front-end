...
export default function ProductDetailPage() {
      ...
      const requestData: ProductAttributeAssignRequest = {
        ...
        attributeAssignments: data.attributeAssignments.filter((assignment) => {
          ...
          const hasSelectedValues =
            assignment.selectedValueIds &&
            assignment.selectedValueIds.length > 0;
          const hasTextValue =
            assignment.textValue && assignment.textValue.trim() !== '';
  ...
  const handleRemoveAllAttributes = async () => {
    if (
      !confirm(
        'Are you sure you want to remove all attributes from this product? This will delete all variants.'
      )
    ) {
      return;
    }
  ...
  const handleDeleteVariant = async (
    ...
    if (
      !confirm(
        `Are you sure you want to delete variant "${variantName}"? This action cannot be undone.`
      )
    ) {
      return;
    }
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <div className="mt-1">
                    {product.category ? (
                      <Link
                        href={`/app/menu/categories/${product.category.id}/detail`}
                      >
                        <Badge
                          variant="outline"
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex items-center justify-between p-3 border rounded-lg">
                  ...
                  <Badge
                    variant={product.canBePurchased ? 'default' : 'secondary'}
                  >
              ...
              {product.salesInfo ? (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="mt-1">
                      {product.salesInfo.salesDescription || '-'}
                    </div>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-500">
                    ...
                    <div className="mt-1">
                      {product.salesInfo.invoicePolicy || '-'}
                    </div>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-500">
                    ...
                    <div className="mt-1">
                      <Badge
                        variant={
                          product.salesInfo.trackService
                            ? 'default'
                            : 'secondary'
                        }
                      >
                  ...
                  <div>
                    ...
                    <div className="mt-1">
                      {product.salesInfo.customerLeadTime || '-'}
                    </div>
                  </div>
                </div>
              ) : (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="mt-1">
                      <Badge
                        variant={
                          product.posInfo.availableInPos
                            ? 'default'
                            : 'secondary'
                        }
                      >
                  ...
                  <div>
                    ...
                    <div className="mt-1">
                      {product.posInfo.posCategoryName || '-'}
                    </div>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-500">
                  ...
                  <div>
                    ...
                    <div className="mt-1">
                      <Badge
                        variant={
                          product.posInfo.toWeigh ? 'default' : 'secondary'
                        }
                      >
              ...
              {product.inventoryInfo ? (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <div className="mt-1">
                      {product.inventoryInfo.inventoryRule || '-'}
                    </div>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-500">
              ...
              {product.purchaseInfo ? (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="mt-1">
                      {product.purchaseInfo.purchaseDescription || '-'}
                    </div>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-500">
                    ...
                    <div className="mt-1">
                      {product.purchaseInfo.vendorLeadTime || '-'}
                    </div>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-500">
                    ...
                    <div className="mt-1">
                      {product.purchaseInfo.minimumQuantity || '-'}
                    </div>
                  </div>
                </div>
              ) : (
              ...
              {product.accountingInfo ? (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="mt-1">
                      {product.accountingInfo.revenueAccount || '-'}
                    </div>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-500">
                    ...
                    <div className="mt-1">
                      {product.accountingInfo.expenseAccount || '-'}
                    </div>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-500">
                    ...
                    <div className="mt-1">
                      {product.accountingInfo.taxCategory || '-'}
                    </div>
                  </div>
                </div>
              ) : (
        ...
        <TabsContent value="variants" className="space-y-6">
          ...
          >
            <TabsList className="grid w-full grid-cols-2">
              ...
              <TabsTrigger value="assign">Create Variants</TabsTrigger>
            </TabsList>
                ...
                <Card className="border-dashed">
                  <CardContent className="flex flex-col items-center justify-center py-8">
                    ...
                    <p className="text-gray-500 mb-4">
                      Assign attributes first to create variants automatically,
                                ...
                                <div className="flex flex-wrap gap-2">
                                  {variant.attributeValues
                                    ?.filter((attrValue) => {
                                      const attribute = attributes.find(
                                        (attr) =>
                                          attr.id === attrValue.attributeId
                                      );
                                      return (
                                        attribute?.isMoneyAttribute !== true
                                      );
                                    })
                                    .map((attrValue) => (
                                      <Badge
                                      ...
                                      >
                                        ...
                                        {attrValue.textValue || attrValue.name}
                                      </Badge>
                                    ))}
                                </div>
            ...
            <TabsContent value="assign" className="space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Select attribute values to automatically generate product
                    variants.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <Form {...assignmentForm}>
                    <form
                      onSubmit={assignmentForm.handleSubmit(onAssignAttributes)}
                      className="space-y-6"
                    >
                      {attributes
                        .filter((attr) => attr.status === 'ACTIVE')
                          ...
                          <div key={attribute.id} className="space-y-3">
                            <FormLabel className="text-base font-medium flex items-center gap-2">
                              ...
                              {attribute.displayType === 'COLOR' && (
                                <div className="w-4 h-4 rounded bg-gradient-to-r from-red-500 to-blue-500" />
                              )}
                            ...
                            {attribute.displayType === 'SELECT' && (
                              <div className="space-y-2">
                                <div className="text-sm text-gray-600">
                                  Select multiple values (hold Ctrl/Cmd)
                                </div>
                                <FormField
                            ...
                            {attribute.displayType === 'RADIO' && (
                              <div className="space-y-2">
                                <div className="text-sm text-gray-600">
                                  Select multiple values for variant generation
                                </div>
                            ...
                            {attribute.displayType === 'TEXTBOX' && (
                              <div className="space-y-2">
                                <div className="text-sm text-gray-600">
                                  Enter text value (leave empty to skip this
                                  attribute)
                                </div>
                                <FormField
                                  control={assignmentForm.control}
                      ...
                      <div className="flex justify-end">
                        ...
                        >
                          <Settings className="h-4 w-4 mr-2" />
                          {assignAttributesMutation.isPending
                            ? 'Assigning...'
                            : 'Assign Attributes'}
                        </Button>
                      </div>
      ...
      >
        <DialogContent className="sm:max-w-[500px]">
          ...
          <Form {...editVariantForm}>
            <form
              onSubmit={editVariantForm.handleSubmit(onUpdateVariant)}
              className="space-y-4"
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <FormField
