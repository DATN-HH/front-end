...
export default function ProductDetailPage() {
    ...
    const onUpdateVariant = async (data: EditVariantFormData) => {
        ...
        try {
            ...
            if (
                data.internalReference !== undefined ||
                ...
                <TabsContent value="sales" className="space-y-6">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Sales-related settings and information for this
                                product.
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Point of Sale specific settings for this
                                product.
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4">
                                ...
                                <Card className="border-dashed">
                                    <CardContent className="flex flex-col items-center justify-center py-8">
                                        ...
                                        <p className="text-gray-500 mb-4">
                                            Assign attributes first to create
                                            variants automatically, or create
                                            custom variants.
                                        </p>
                                    ...
                                    <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
                                        ...
                                        <div className="flex gap-2">
                                            ...
                                            <Button
                                                ...
                                                className="text-red-500"
                                                disabled={
                                                    removeAttributesMutation.isPending
                                                }
                                            >
                        ...
                        <TabsContent value="assign" className="space-y-4">
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Select attribute values to automatically
                ...
                <TabsContent value="analytics" className="space-y-6">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Performance metrics and statistics for this
                                product.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                                        ...
                                        <div className="text-2xl font-bold text-blue-600">
                                            {product.smartButtons.onHandCount ||
                                                0}
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                                        ...
                                        <div className="text-2xl font-bold text-green-600">
                                            {product.smartButtons.soldCount ||
                                                0}
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-orange-50 border border-orange-200 rounded-lg p-4">
                                        ...
                                        <div className="text-2xl font-bold text-orange-600">
                                            {product.smartButtons.ordersCount ||
                                                0}
                                        </div>
                                    </div>
            ...
            >
                <DialogContent className="sm:max-w-[500px]">
                    ...
                    <Form {...editVariantForm}>
                        <form
                            onSubmit={editVariantForm.handleSubmit(
                                onUpdateVariant
                            )}
                            className="space-y-4"
                        >
