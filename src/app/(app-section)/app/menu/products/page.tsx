...
export default function ProductsPage() {
    ...
    const apiParams: ProductListParams = useMemo(() => {
        ...
        return params;
    }, [pageIndex, pageSize, keyword, selectedType, canBeSold, archived, sorting]);
                ...
                <div className="flex-1 flex flex-col min-h-0">
                    ...
                    <CardContent className="pt-0 flex-1 flex flex-col min-h-0">
                        ...
                        <div className="flex-1 space-y-2 min-h-0 overflow-y-auto">
                            ...
                            <div className="grid grid-cols-2 gap-2 text-sm">
                                ...
                                <div>
                                    ...
                                    <div className="font-medium text-sm">{formatCurrency(product.cost)}</div>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center justify-between text-sm">
                                ...
                                <Badge variant={product.canBeSold ? 'default' : 'secondary'} className="text-xs">
                        ...
                        <div className="space-y-2 mt-3 flex-shrink-0">
                            <div className="flex gap-2">
                                <Link href={`/app/menu/products/${product.id}/detail`} className="flex-1">
            ...
            {viewMode === 'grouped' && groupedData && groupedData.length > 0 && (
                <div className="flex items-center justify-between bg-gray-50 px-4 py-2 rounded-lg">
                    <div className="text-sm text-gray-600">
                        {groupedData.length} groups • {groupedData.reduce((sum, group) => sum + group.totalCount, 0)} total products
                    </div>
                    <div className="flex items-center space-x-2">
                        <Button
                            variant="outline"
