...
export default function ProductsPage() {
    ...
    const expandAllGroups = () => {
        if (groupedData) {
            setExpandedGroups(
                new Set(groupedData.map((group) => group.groupKey))
            );
        }
    };
            ...
            cell: ({ row }) => {
                ...
                return (
                    <div className="flex gap-2">
                        <Link
                            href={`/app/menu/products/${row.original.id}/detail`}
                        >
    ...
    const ProductCard = ({ product }: { product: ProductListResponse }) => {
        ...
        const isLowStock =
            threshold && stock !== undefined && stock <= threshold;
                        ...
                        <div className="space-y-2 mt-3 flex-shrink-0">
                            ...
                            {!isArchived ? (
                                <Button
                                    ...
                                    onClick={() =>
                                        handleArchive(product.id, product.name)
                                    }
                                    disabled={archiveProductMutation.isPending}
                                >
                ...
                left={
                    <div className="flex items-center space-x-4">
                        ...
                        <div className="flex border rounded-md overflow-hidden">
                            ...
                            <Button
                                variant={
                                    viewMode === 'grouped' ? 'default' : 'ghost'
                                }
                                size="sm"
