...
import { Plus, Edit, Archive, Eye, FolderOpen, Search } from 'lucide-react';
...
export default function CategoriesPage() {
    ...
    const columns: ColumnDef<CategoryResponse>[] = [
        ...
        },
        {
            ...
            header: 'Products',
            cell: ({ row }) => (
                <ProductCountCell categoryId={row.original.id} />
            ),
        },
        {
            accessorKey: 'status',
            ...
            cell: ({ row }) => {
                return (
                    <div className="flex gap-2">
                        <Link
                            href={`/app/menu/categories/${row.original.id}/detail`}
                        >
