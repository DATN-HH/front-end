          ...
          <div className="flex items-center justify-between pt-2 border-t">
            <div className="flex gap-2">
              <Badge
                ...
                className="text-xs"
              >
                {product.canBeSold ? 'Sellable' : 'Not Sellable'}
              </Badge>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Category usage and metrics</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 gap-4">
                  <div>
                  ...
                  {category.createdBy && (
                    <div>
                      ...
                      <p className="text-sm">{category.createdBy}</p>
                    </div>
                  )}
                  {category.updatedBy && (
                    <div>
                      ...
                      <p className="text-sm">{category.updatedBy}</p>
                    </div>
                  )}
                </div>
              </CardContent>
              ...
              {productsLoading ? (
                ...
                <div className="space-y-4">
                  ...
                  <div className="pt-4 border-t">
                    <Link href={`/app/menu/products?category=${category.id}`}>
