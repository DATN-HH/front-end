...
import { Plus, Edit, Archive, Tag, TrendingUp } from 'lucide-react';
...
export default function TagsPage() {
  ...
  const [selectedTag, setSelectedTag] = useState<ProductTagResponse | null>(
    null
  );
    ...
    },
    {
      ...
      cell: ({ row }) => (
        <div className="text-center">
          <Badge variant="outline">{row.original.productCount || 0}</Badge>
        </div>
      ),
    },
    {
