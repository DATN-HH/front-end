                    ...
                    <div className="space-y-8">
                            ...
                            <Card className="bg-gradient-to-r from-primary/5 to-secondary/5 border-primary/20">
                                <CardHeader className="p-4 lg:p-6">
                                    ...
                                    <CardDescription className="text-sm lg:text-base">
                                        <span className="hidden sm:inline">
                                            Current settings overview for your
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-4">
                                        ...
                                        <div className="bg-card p-3 lg:p-4 rounded-xl border shadow-sm hover:shadow-md transition-shadow">
                                            <div className="text-lg lg:text-2xl font-bold text-accent-foreground mb-1">
                                                {
                                                    config.minRestHoursBetweenShifts
                                                }
                                                h
                                            </div>
                                            <div className="text-xs lg:text-sm text-muted-foreground font-medium">
                        ...
                        <Card className="shadow-sm hover:shadow-md transition-shadow">
                            <CardHeader className="bg-gradient-to-r from-accent/10 to-accent/5 rounded-t-lg p-4 lg:p-6">
                                ...
                                <CardDescription className="text-sm lg:text-base">
                                    <span className="hidden sm:inline">
                                        Allow employees to register for
                                        available shifts independently
                                    </span>
                                    <span className="sm:hidden">
                                    ...
                                    <div className="space-y-6 pl-4 lg:pl-6 border-l-2 border-accent/30 bg-accent/5 p-4 rounded-lg">
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <Input
                                                ...
                                                max="30"
                                                value={
                                                    formData.registrationDaysInAdvance ??
                                                    ''
                                                }
                                                onChange={(e) =>
                                                    handleInputChange(
                                                    ...
                                                    <strong>
                                                        {
                                                            DAYS_OF_WEEK.find(
                                                                (d) =>
                                                                    d.value ===
                                                                    formData.registrationEndDayOfWeek
                                                            )?.label
                                                        }
                                                    </strong>{' '}
                                                    for shifts{' '}
                        ...
                        <Card className="shadow-sm hover:shadow-md transition-shadow">
                            <CardHeader className="bg-gradient-to-r from-accent/10 to-accent/5 rounded-t-lg p-4 lg:p-6">
                                ...
                                <CardDescription className="text-sm lg:text-base">
                                    <span className="hidden sm:inline">
                                        Set maximum limits and minimum rest
                                        periods to ensure work-life balance
                                    </span>
                                    <span className="sm:hidden">
                                        Set limits and rest periods
                                    </span>
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-6 pt-6 p-4 lg:p-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 lg:gap-6">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <Input
                                            ...
                                            max="24"
                                            value={
                                                formData.minRestHoursBetweenShifts ??
                                                ''
                                            }
                                            onChange={(e) =>
                                                handleInputChange(
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6">
                                    <div className="space-y-3">
                                        ...
                                        <Input
                                            ...
                                            max="168"
                                            value={
                                                formData.responseDeadlineHours ??
                                                ''
                                            }
                                            onChange={(e) =>
                                                handleInputChange(
                                        ...
                                        <p className="text-xs text-muted-foreground">
                                            <span className="hidden sm:inline">
                                                Time limit for employees to
                                                respond to shift assignments
                                            </span>
                                            <span className="sm:hidden">
                                                Response time limit
                                            </span>
                        ...
                        <DialogHeader>
                            ...
                            <DialogDescription className="text-base leading-relaxed">
                                <span className="hidden sm:inline">
                                    ...
                                    schedule configuration? This action cannot
                                    be undone and will reset all scheduling
                                    rules to default values.
                                </span>
                                <span className="sm:hidden">
                                    Delete this configuration? This action
                                    cannot be undone and will reset all rules to
                                    default.
                                </span>
                            </DialogDescription>
                        </DialogHeader>
