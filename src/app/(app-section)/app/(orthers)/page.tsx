            ...
            <div className="max-w-7xl mx-auto space-y-8">
                ...
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <MetricCard
                        title="Total Orders"
                        value={
                            isLoading ? '...' : (orderMetrics?.totalOrders ?? 0)
                        }
                        change={ordersChange}
                        icon={ShoppingCart}
                        isLoading={isLoading}
                    ...
                    <MetricCard
                        title="Peak Hour"
                        value={
                            isLoading ? '...' : `${peakHours?.peakHour ?? 0}:00`
                        }
                        icon={Clock}
                        isLoading={isLoading}
                    ...
                    <MetricCard
                        ...
                        value={
                            isLoading
                                ? '...'
                                : formatCurrency(
                                      productStats?.totalItemRevenue ?? 0
                                  )
                        }
                        icon={DollarSign}
                        isLoading={isLoading}
                            ...
                            <CardContent className="text-center py-16">
                                <div className="max-w-md mx-auto">
                                    ...
                                    <p className="text-gray-600 mb-6 leading-relaxed">
                                        ...
                                        range and filters. Try adjusting your
                                        filters or selecting a different time
                                        period.
                                    </p>
                                    <Button
                                        onClick={handleRefresh}
