...
export default function EmployeeShiftLeavePage() {
    ...
    const handleSelectAllShifts = (checked: boolean) => {
        setFormData((prev) => ({
            ...prev,
            selectedShiftIds: checked
                ? sortedShifts.map((shift) => shift.id)
                : [],
        }));
    };
    ...
    // Check if some shifts are selected (indeterminate state)
                                    ...
                                    <div className="border rounded-lg p-4 bg-gray-50">
                                        <div className="space-y-3">
                                            <div className="text-sm font-medium text-gray-700 mb-3">
                                                Shifts Timeline (sorted by start
                                                time)
                                            </div>
                                                        ...
                                                        (shift, index) => (
                                                            <div
                                                                ...
                                                                className={cn(
                                                                    ...
                                                                    formData.selectedShiftIds.includes(
                                                                        shift.id
                                                                    )
                                                            ...
                                                            >
                                                                <Checkbox
                                                                    id={`shift-${shift.id}`}
                                                                    checked={formData.selectedShiftIds.includes(
                                                                        shift.id
                                                                    )}
                                                                    onCheckedChange={(
                                                                        checked
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <div className="flex flex-wrap gap-2 mt-2">
                                    {selectedRequest.requestedShifts.map(
                                        (shift) => (
                                            <Badge
                                                key={shift.id}
                                                variant="secondary"
                            ...
                            {selectedRequest.affectedShiftsCount > 0 && (
                                <div>
                                    ...
                                    <p className="text-sm mt-1">
                                        {selectedRequest.affectedShiftsCount}{' '}
                                        shifts
                                    </p>
                                </div>
                            )}
