...
import { useBookingTables, BookingTableResponseDto, BookingTableListRequest } from '@/api/v1/table-booking';
...
import TableBookingWrapper from '@/components/table-booking/TableBookingWrapper';
...
export function TableReservation() {
    ...
    const [bookingTables, setBookingTables] = useState<BookingTableResponseDto[]>([]);
