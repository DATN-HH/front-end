              ...
              <div className="flex items-start justify-between gap-3">
                <div className="flex items-center gap-3 flex-1 min-w-0 pr-2">
                  ...
                  <div className="flex-1 min-w-0">
                    <CardTitle
                      className="text-lg leading-tight break-all hyphens-auto"
                      style={{
            ...
            <CardContent className="pt-0">
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <Badge
                    variant={
                      tableType.status === 'ACTIVE' ? 'default' : 'secondary'
                    }
                  >
                    {tableType.status}
                  </Badge>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-medium">
                    {formatCurrency(tableType.depositForBooking)}
                  </span>
                </div>
                <div className="flex justify-between items-center">
                ...
                <div className="text-xs text-gray-500 mt-4 space-y-1">
                  <div>
                    Created:{' '}
                    {new Date(tableType.createdAt).toLocaleDateString()}
                  </div>
                  <div>
                    Updated:{' '}
                    {new Date(tableType.updatedAt).toLocaleDateString()}
                  </div>
                </div>
              </div>
            </CardContent>
