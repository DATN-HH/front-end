...
import { useCreateTableType, validateTableTypeData, TableTypeCreateRequest } from '@/api/v1/table-types';
...
export function CreateTableTypeDialog({ open, onOpenChange }: CreateTableTypeDialogProps) {
    ...
    const handleChange = (field: keyof TableTypeCreateRequest, value: string | number) => {
            ...
            <DialogContent className="sm:max-w-[500px]">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <DialogFooter>
                        ...
                        <Button type="submit" disabled={createTableTypeMutation.isPending}>
                            {createTableTypeMutation.isPending ? 'Creating...' : 'Create Table Type'}
                        </Button>
                    </DialogFooter>
                </form>
            </DialogContent>
