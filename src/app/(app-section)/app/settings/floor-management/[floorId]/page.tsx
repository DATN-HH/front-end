...
import { CreateTableDialog } from '@/features/booking/components/floor-management/[floorId]/CreateTableDialog';
import { DeleteTableDialog } from '@/features/booking/components/floor-management/[floorId]/DeleteTableDialog';
import { EditTableDialog } from '@/features/booking/components/floor-management/[floorId]/EditTableDialog';
import { FloorCanvas } from '@/features/booking/components/floor-management/[floorId]/FloorCanvas';
import { TablePropertiesPanel } from '@/features/booking/components/floor-management/[floorId]/TablePropertiesPanel';
...
export function FloorDetailPage() {
    ...
    const handleCreateTable = async (
        data: Omit<TableCreateRequest, 'floorId'>
    ) => {
        try {
            ...
            <div className="min-h-screen bg-white flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="text-gray-600 mb-4">
                        This floor does not exist or has been deleted
                    </p>
                    <Button
                        onClick={() =>
                            router.push('/app/settings/floor-management')
                        }
                    >
                    ...
                    <div className="flex-1 flex flex-col">
                        ...
                        <div className="flex-1 p-4">
                            <FloorCanvas
                                ...
                                tables={
                                    Array.isArray(floorData.tables)
                                        ? floorData.tables
                                        : []
                                }
