...
function ScheduleConfiguration() {
  ...
  const { data: config, isLoading: isLoadingConfig } = useBranchScheduleConfig(
    branchId!
  );
  ...
  const handleInputChange = (
    field: keyof BranchScheduleConfigRequest,
    value: any
  ) => {
    setFormData((prev) => ({
      ...prev,
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      success(
        ...
        'Branch schedule configuration has been updated successfully'
      );
    } catch (err: any) {
      error(
        'Update Failed',
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      success(
        ...
        'Branch schedule configuration has been deleted successfully'
      );
      ...
      <div className="flex items-center justify-center py-16">
        <div className="text-center space-y-3">
          ...
          <p className="text-muted-foreground max-w-md">
            Unable to load branch information. Please contact your
            administrator.
          </p>
        </div>
      </div>
          ...
          <div className="space-y-8">
              ...
              <Card className="bg-gradient-to-r from-primary/5 to-secondary/5 border-primary/20">
                <CardHeader className="p-4 lg:p-6">
                  ...
                  <CardDescription className="text-sm lg:text-base">
                    <span className="hidden sm:inline">
                      Current settings overview for your branch scheduling
                      system
                    </span>
                ...
                <CardContent className="p-4 lg:p-6">
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-4">
                    <div className="bg-card p-3 lg:p-4 rounded-xl border shadow-sm hover:shadow-md transition-shadow">
                      <div className="text-lg lg:text-2xl font-bold text-primary mb-1">
                    ...
                    <div className="bg-card p-3 lg:p-4 rounded-xl border shadow-sm hover:shadow-md transition-shadow">
                      <div className="text-lg lg:text-2xl font-bold text-secondary-foreground mb-1">
                    ...
                    <div className="bg-card p-3 lg:p-4 rounded-xl border shadow-sm hover:shadow-md transition-shadow">
                      <div className="text-lg lg:text-2xl font-bold text-accent-foreground mb-1">
                    ...
                    <div className="bg-card p-3 lg:p-4 rounded-xl border shadow-sm hover:shadow-md transition-shadow">
                      <div className="text-lg lg:text-2xl font-bold text-gold-600 mb-1">
                        {config.responseDeadlineHours}h
                      </div>
                      <div className="text-xs lg:text-sm text-muted-foreground font-medium">
                        Response Deadline
                      </div>
                  ...
                  <div className="flex flex-wrap gap-2 mt-4 lg:mt-6 pt-3 lg:pt-4 border-t">
                    <Badge
                      variant={
                        config.allowSelfShiftRegistration
                          ? 'default'
                          : 'secondary'
                      }
                      className="text-xs"
                    ...
                    <Badge
                      variant={
                        config.autoAssignEnabled ? 'default' : 'secondary'
                      }
                      className="text-xs"
                    >
                    ...
                    <Badge
                      variant={
                        config.requireManagerApproval ? 'default' : 'secondary'
                      }
                      className="text-xs"
                    >
            ...
            <Card className="shadow-sm hover:shadow-md transition-shadow">
              <CardHeader className="bg-gradient-to-r from-accent/10 to-accent/5 rounded-t-lg p-4 lg:p-6">
                ...
                <CardDescription className="text-sm lg:text-base">
                  <span className="hidden sm:inline">
                    Allow employees to register for available shifts
                    independently
                  </span>
                  <span className="sm:hidden">
                    Employee self-registration for shifts
                  </span>
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6 pt-6 p-4 lg:p-6">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-4 bg-muted/30 rounded-xl border space-y-2 sm:space-y-0">
                  <div className="space-y-1">
                    ...
                    <div className="text-sm text-muted-foreground">
                      <span className="hidden sm:inline">
                        Allow employees to register for open shifts
                      </span>
                      <span className="sm:hidden">
                  ...
                  <div className="flex justify-center sm:justify-end">
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        handleInputChange('allowSelfShiftRegistration', checked)
                      }
                    />
                  </div>
                </div>
                ...
                {formData.allowSelfShiftRegistration && (
                  <div className="space-y-6 pl-4 lg:pl-6 border-l-2 border-accent/30 bg-accent/5 p-4 rounded-lg">
                    ...
                    <div className="space-y-3">
                      <Label
                        htmlFor="registrationDaysInAdvance"
                      ...
                      <p className="text-xs text-muted-foreground">
                        How many days in advance employees can register for
                        shifts (1-30 days)
                      </p>
                    </div>
                    ...
                    <Alert className="bg-accent/10 border-accent/30">
                      ...
                      <AlertDescription className="text-accent-foreground text-sm">
                        ...
                        <span className="hidden sm:inline">
                          {' '}
                          Employees can register from{' '}
                          <strong>
                            {
                              DAYS_OF_WEEK.find(
                                (d) =>
                                  d.value ===
                                  formData.registrationStartDayOfWeek
                              )?.label
                            }
                          </strong>{' '}
                          to{' '}
                          <strong>
                            {
                              DAYS_OF_WEEK.find(
                                (d) =>
                                  d.value === formData.registrationEndDayOfWeek
                              )?.label
                            }
                          </strong>{' '}
                          for shifts{' '}
                          <strong>
                            {formData.registrationDaysInAdvance} days
                          </strong>{' '}
                          in advance.
                        </span>
                        <span className="sm:hidden">
                          ...
                          , {formData.registrationDaysInAdvance} days ahead.
                        </span>
                      </AlertDescription>
                    </Alert>
                  </div>
            ...
            <Card className="shadow-sm hover:shadow-md transition-shadow">
              <CardHeader className="bg-gradient-to-r from-accent/10 to-accent/5 rounded-t-lg p-4 lg:p-6">
                <CardTitle className="flex items-center gap-3 text-foreground text-base lg:text-lg">
                  ...
                  <span className="hidden sm:inline">
                    Shift Limits & Restrictions
                  </span>
                  <span className="sm:hidden">Shift Limits</span>
                </CardTitle>
                <CardDescription className="text-sm lg:text-base">
                  <span className="hidden sm:inline">
                    Set maximum limits and minimum rest periods to ensure
                    work-life balance
                  </span>
              ...
              <CardContent className="space-y-6 pt-6 p-4 lg:p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6">
                  <div className="space-y-3">
                    ...
                    <p className="text-xs text-muted-foreground">
                      <span className="hidden sm:inline">
                        Time limit for employees to respond to shift assignments
                      </span>
          ...
          <DialogContent className="sm:max-w-md max-h-[90vh] overflow-y-auto m-4">
            <DialogHeader>
              ...
              <DialogDescription className="text-base leading-relaxed">
                <span className="hidden sm:inline">
                  Are you sure you want to delete this schedule configuration?
                  This action cannot be undone and will reset all scheduling
                  rules to default values.
                </span>
                <span className="sm:hidden">
                  Delete this configuration? This action cannot be undone and
                  will reset all rules to default.
                </span>
              </DialogDescription>
            </DialogHeader>
