                    ...
                    <div className="space-y-8">
                        ...
                        {config && (
                            <Card className="bg-gradient-to-r from-primary/5 to-secondary/5 border-primary/20">
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Current settings overview for your branch scheduling system
                                    </CardDescription>
                                </CardHeader>
                                <CardContent>
                                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                        <div className="bg-card p-4 rounded-xl border shadow-sm hover:shadow-md transition-shadow">
                                            <div className="text-2xl font-bold text-primary mb-1">{config.maxShiftsPerWeek}</div>
                                            <div className="text-sm text-muted-foreground font-medium">Max Shifts/Week</div>
                                        </div>
                                        <div className="bg-card p-4 rounded-xl border shadow-sm hover:shadow-md transition-shadow">
                                            <div className="text-2xl font-bold text-secondary-foreground mb-1">{config.maxShiftsPerDay}</div>
                                            <div className="text-sm text-muted-foreground font-medium">Max Shifts/Day</div>
                                        </div>
                                        <div className="bg-card p-4 rounded-xl border shadow-sm hover:shadow-md transition-shadow">
                                            <div className="text-2xl font-bold text-accent-foreground mb-1">{config.minRestHoursBetweenShifts}h</div>
                                            <div className="text-sm text-muted-foreground font-medium">Min Rest Time</div>
                                        </div>
                                        <div className="bg-card p-4 rounded-xl border shadow-sm hover:shadow-md transition-shadow">
                                            <div className="text-2xl font-bold text-gold-600 mb-1">{config.responseDeadlineHours}h</div>
                                            <div className="text-sm text-muted-foreground font-medium">Response Deadline</div>
                                        </div>
                                    </div>
                        ...
                        <Card className="shadow-sm hover:shadow-md transition-shadow">
                            <CardHeader className="bg-gradient-to-r from-accent/10 to-accent/5 rounded-t-lg">
                                ...
                                <CardDescription>
                                    Allow employees to register for available shifts independently
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-6 pt-6">
                                ...
                                {formData.allowSelfShiftRegistration && (
                                    <div className="space-y-6 pl-6 border-l-2 border-accent/30 bg-accent/5 p-4 rounded-lg">
                                        ...
                                        <Alert className="bg-accent/10 border-accent/30">
                                            ...
                                            <AlertDescription className="text-accent-foreground">
                                                <strong>Registration Window:</strong> Employees can register from{' '}
                                                ...
                                                <strong>{formData.registrationDaysInAdvance} days</strong> in advance.
                                            </AlertDescription>
                                        </Alert>
                                    </div>
                                )}
                        ...
                        <Card className="shadow-sm hover:shadow-md transition-shadow">
                            <CardHeader className="bg-gradient-to-r from-accent/10 to-accent/5 rounded-t-lg">
                                ...
                                <CardDescription>
                                    Set maximum limits and minimum rest periods to ensure work-life balance
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-6 pt-6">
                    ...
                    <DialogContent className="sm:max-w-md">
                        <DialogHeader>
                            ...
                            <DialogDescription className="text-base leading-relaxed">
                                Are you sure you want to delete this schedule configuration? This action cannot be undone and will reset all scheduling rules to default values.
                            </DialogDescription>
                        </DialogHeader>
