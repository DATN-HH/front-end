...
export default function EmployeeShiftLeavePage() {
    ...
    return (
        <div className="space-y-6">
                    ...
                    {isLoadingBalance ? (
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            <div className="text-center">
                                <div className="text-2xl font-bold text-blue-600">{balance.totalShifts}</div>
                                <div className="text-sm text-gray-600">Total Shifts</div>
                            </div>
                            <div className="text-center">
                                <div className="text-2xl font-bold text-red-600">{balance.usedShifts}</div>
                                <div className="text-sm text-gray-600">Used</div>
                            </div>
                            <div className="text-center">
                                <div className="text-2xl font-bold text-green-600">{balance.bonusShifts}</div>
                                <div className="text-sm text-gray-600">Bonus</div>
                            </div>
                            <div className="text-center">
                                <div className="text-2xl font-bold text-purple-600">{balance.availableShifts}</div>
            ...
            <Card>
                <CardHeader>
                    <CardTitle>Shift Leave Requests</CardTitle>
                </CardHeader>
                <CardContent>
                    {isLoadingRequests ? (
                        <div>Loading...</div>
