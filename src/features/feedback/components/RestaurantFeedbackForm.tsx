...
import { customerFeedbackAPI, RestaurantFeedbackCreateDto, FeedbackRatingDto } from '@/api/v1/feedback';
...
export function RestaurantFeedbackForm({ branches, onSuccess, onCancel }: RestaurantFeedbackFormProps) {
  ...
  const onSubmit = async (data: FeedbackFormData) => {
    ...
    try {
      ...
      // Show success state
      setIsSuccess(true);
      toast.success('Success', 'Your feedback has been submitted successfully!');
  ...
  return (
    <Card className="max-w-4xl mx-auto">
      <CardHeader>
        ...
        <CardDescription>
          Share your dining experience with us. Your feedback helps us improve our service.
        </CardDescription>
      </CardHeader>
      <CardContent>
        {isSuccess ? (
          ...
          <div className="text-center py-8 space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-gray-600">Your restaurant feedback has been submitted successfully.</p>
              <p className="text-sm text-gray-500">We appreciate your time and will use your feedback to improve our service.</p>
            </div>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Share details about your dining experience
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
