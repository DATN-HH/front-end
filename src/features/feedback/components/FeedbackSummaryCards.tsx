...
import { MessageSquare, Star, TrendingUp, Users, Package, Building } from 'lucide-react';
...
export function FeedbackSummaryCards({ summary, loading }: FeedbackSummaryCardsProps) {
  const cards = [
    {
