...
interface FeedbackListProps {
  ...
  onPaginationChange: (pagination: { page: number; size: number; total: number }) => void;
  onRefresh: () => void;
}
                    ...
                    <div className="flex items-start gap-4">
                          ...
                          <div className="bg-blue-50 border-l-4 border-blue-200 p-3 rounded">
                            <div className="flex items-center gap-2 mb-1">
                              ...
                              <span className="text-xs font-medium text-blue-800">
                                Response by {item.respondedByName}
                              </span>
                      ...
                      <div className="flex flex-col gap-2 items-end">
                        <div className="flex flex-col gap-1">
                          <Badge className={getStatusColor(item.feedbackStatus)}>
                            {item.feedbackStatus}
                          </Badge>
