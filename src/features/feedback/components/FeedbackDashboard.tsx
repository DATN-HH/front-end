...
export function FeedbackDashboard({ branches }: FeedbackDashboardProps) {
    ...
    const [summaryData, setSummaryData] = useState<FeedbackSummaryDto | null>(
        null
    );
    ...
    const handleExport = async (format: 'csv' | 'excel') => {
        try {
            ...
            toast.success(
                'Success',
                `Feedback data exported as ${format.toUpperCase()}`
            );
        } catch (error: any) {
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-muted-foreground">
                        Monitor and respond to customer feedback across all
                        branches
                    </p>
                </div>
            ...
            {/* Summary Cards */}
            {summaryData && (
                <FeedbackSummaryCards summary={summaryData} loading={loading} />
            )}
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="text-center py-8">
                                ...
                                <p className="text-muted-foreground">
                                    Advanced reporting features will be
