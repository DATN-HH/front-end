...
import { PreOrderSuccessDialog } from './PreOrderSuccessDialog';
...
export function CreatePreOrderDialog({
    ...
    const [createdPreOrder, setCreatedPreOrder] =
        useState<AdminCreatePreOrderResponse | null>(null);
    ...
    return (
        <>
                            ...
                            <CardContent>
                                {orderItems.length === 0 ? (
                                    <div className="text-center py-8 text-gray-500">
                                        ...
                                        <p className="text-sm">
                                            Click "Add Item" to start building
                                            the order
                                        </p>
                                    </div>
                                ) : (
            ...
            <PreOrderSuccessDialog
                open={showSuccessDialog}
                onOpenChange={setShowSuccessDialog}
                preOrderData={createdPreOrder}
                onPaymentSuccess={() => {
