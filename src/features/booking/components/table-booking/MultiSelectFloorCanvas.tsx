                    ...
                    tables.map((table) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                {/* Availability Icon - outside table element */}
                                {onTableAvailabilityClick && (
                                    <div
                                        className="absolute -top-2 -right-2 w-6 h-6 bg-orange-500 rounded-full flex items-center justify-center hover:bg-orange-600 transition-colors cursor-pointer z-30 shadow-md border-2 border-white"
                                        onClick={(e) => {
                                            e.stopPropagation();
