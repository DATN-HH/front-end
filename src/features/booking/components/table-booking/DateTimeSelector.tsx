          ...
          <div className="space-y-2">
            ...
            >
              <div className="flex items-center space-x-2">
                ...
                <Label htmlFor="duration-1" className="text-sm cursor-pointer">
                  1 hour
                </Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="2" id="duration-2" />
                <Label htmlFor="duration-2" className="text-sm cursor-pointer">
                  2 hours
                </Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="3" id="duration-3" />
                <Label htmlFor="duration-3" className="text-sm cursor-pointer">
                  3 hours
                </Label>
              </div>
            </RadioGroup>
