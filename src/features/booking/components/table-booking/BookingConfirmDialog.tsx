                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="font-medium">
                          {formatDateTime(bookingData.endTime)}
                        </p>
                      </div>
                    </div>
                    <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="font-medium text-red-600">
                          {formatExpireTime(bookingData.expireTime)}
                        </p>
                          ...
                          paymentStatusData.payload && (
                            <p className="text-xs text-gray-500 mt-1">
                              {paymentStatusData.payload.minutesUntilExpiry > 0
                                ...
                                : paymentStatusData.payload.expired
                                  ? 'Expired'
                                  : 'No time limit'}
                            </p>
                          )}
        ...
        <DialogContent className="max-w-md">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3 pt-4">
              ...
              <Button onClick={handleMenuBookingRedirect} className="flex-1">
                Yes, Order Now
              </Button>
            </div>
          </div>
