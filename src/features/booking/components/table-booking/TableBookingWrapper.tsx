...
export default function TableBookingWrapper({
    ...
    const selectedDateTime = useMemo(() => {
        ...
        // Create datetime string directly without timezone conversion: YYYY-MM-DDTHH:mm:ss
    ...
    const availableTables = useMemo(() => {
        ...
        return tablesStatus.payload.availableTablesList
            .filter(
                (table: any) => table.currentStatus === TableStatus.AVAILABLE
            )
            .map((table: any) => ({
                id: table.tableId,
        ...
        async (e: React.FormEvent) => {
            ...
            if (mode === 'admin') {
                ...
                const adminBookingPayload = {
                    ...
                    customerEmail:
                        bookingData.customerEmail.trim() || undefined,
    ...
    const totalCost = useMemo(() => {
        return selectedTables.reduce((sum, table) => {
            return sum + (table.tableType?.depositForBooking || 0);
        }, 0);
    }, [selectedTables]);
