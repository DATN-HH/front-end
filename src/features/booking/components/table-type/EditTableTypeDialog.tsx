...
export function EditTableTypeDialog({
  open,
  onOpenChange,
  tableType,
}: EditTableTypeDialogProps) {
  ...
  const handleChange = (
    field: keyof TableTypeUpdateRequest,
    value: string | number
  ) => {
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            {errors.depositForBooking && (
              <p className="text-sm text-red-500">{errors.depositForBooking}</p>
            )}
          </div>
