        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Are you sure you want to delete this table type? This
                ...
                <div className="py-4">
                    <Alert className="border-red-200 bg-red-50">
                        ...
                        <AlertDescription className="text-red-800">
                            <strong>Warning:</strong> Deleting this table type
                            will affect all tables currently using this type.
                            Make sure to update or reassign existing tables
                            before deletion.
                        </AlertDescription>
                    </Alert>
