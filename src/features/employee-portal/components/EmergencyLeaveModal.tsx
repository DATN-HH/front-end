    ...
    try {
      ...
      error(
        ...
        err.response?.data?.message ||
          'Failed to submit emergency leave request'
      );
    }
  };
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-destructive/80">
                  This will mark your shift as conflicted and notify all
                  managers at your branch. Emergency leave should only be
                  requested for urgent situations.
                </p>
              </div>
            </div>
          </div>
