...
export const createShiftLeaveColumns = (
  actions: ColumnActions
): ColumnDef<ShiftLeaveRequestDto>[] => [
  {
    id: 'employee',
...
export const allShiftLeaveColumns = (
  actions: Pick<ColumnActions, 'onViewDetails'>
) => createShiftLeaveColumns(actions);
