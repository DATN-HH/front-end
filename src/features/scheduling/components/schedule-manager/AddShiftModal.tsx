        ...
        <DialogHeader className="border-b pb-6">
          <DialogTitle className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-base text-muted-foreground mt-1">
                Register {selectedStaffName} for available shifts on{' '}
          ...
          <Card className="border-2 border-primary/20 bg-primary/5">
            <CardHeader className="pb-4">
              ...
              <CardDescription className="text-muted-foreground">
                Employee: {selectedStaffName} • Role: {staffRole} • Date:{' '}
              ...
              <CardContent className="pt-12 pb-12">
                <div className="text-center text-muted-foreground">
                  ...
                  <p className="text-sm text-muted-foreground mb-2">
                    No open shifts available for role {staffRole} on{' '}
                    {dayjs(selectedDate).format('DD/MM/YYYY')}
                  </p>
              ...
              <Card className="border-2 border-secondary/50 bg-secondary/10">
                <CardHeader className="pb-4">
                  ...
                  <CardDescription className="text-muted-foreground">
                    ...
                    {availableOpenShifts.length !== 1 ? 's' : ''} available for
                    your role
                  </CardDescription>
                </CardHeader>
              </Card>
                    ...
                    >
                      ...
                      <CardContent className="space-y-4 rounded-lg">
                        ...
                        <div className="flex items-center gap-2 text-sm text-foreground">
                          ...
                          <span>
                            Positions remaining: {shiftInfo.remaining}/
                            {shiftInfo.total}({shiftInfo.registered} registered)
                          </span>
                        </div>
