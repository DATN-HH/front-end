...
const ShiftInfoModal = () => {
    ...
    const openShiftsForDate = useMemo(() => {
        ...
        return scheduledShifts.filter(
            (shift: any) =>
                shift.date === dateStr &&
                (!shift.staffId || shift.staffId === null)
        );
                ...
                <Card className="border-2 border-primary/20 bg-primary/5">
                    <CardHeader className="pb-4">
                        ...
                        <CardDescription className="text-muted-foreground">
                            ...
                            {employeeShiftsForDate.length !== 1 ? 's' : ''}{' '}
                            scheduled • Role: {getStaffRole}
                        </CardDescription>
                    </CardHeader>
                </Card>
    ...
    const getModalTitle = () => {
        if (shiftInfoModalType === 'open-shift') {
            return {
                ...
                description:
                    'View and manage open shifts for the selected date',
                icon: Calendar,
            };
        } else if (shiftInfoModalType === 'employee-shift') {
            return {
        ...
        <Dialog open={isShiftInfoModalOpen} onOpenChange={handleClose}>
            ...
            {selectedShiftForReplacement && (
                <StaffReplacementModal
                    ...
                    currentStaffName={
                        selectedShiftForReplacement.currentStaffName
                    }
