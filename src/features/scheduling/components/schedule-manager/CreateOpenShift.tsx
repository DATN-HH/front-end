...
const CreateOpenShift = ({ selectedDate }: CreateOpenShiftProps) => {
    ...
    const scheduledShiftsForDate = useMemo(() => {
        ...
        return (
            scheduledShifts?.filter((shift) => shift.date === dateString) || []
        );
    ...
    const isShiftScheduled = (shiftId: number) => {
        return scheduledShiftsForDate.some(
            (scheduledShift) => scheduledShift.shiftId === shiftId
        );
    };
    ...
    return (
        <Dialog
            open={isCreateOpenShiftDialogOpen}
            onOpenChange={setIsCreateOpenShiftDialogOpen}
        >
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="grid gap-4">
                                {availableShifts.map((shift) => {
                                    const isScheduled = isShiftScheduled(
                                        shift.id
                                    );
                                                            ...
                                                            <div className="flex items-center gap-2">
                                                                ...
                                                                {!isScheduled && (
                                                                    <Button
                                                                        ...
                                                                        disabled={
                                                                            createScheduledShift.isPending
                                                                        }
