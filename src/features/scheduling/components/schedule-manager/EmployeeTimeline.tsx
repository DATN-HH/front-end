...
const EmployeeTimeline = () => {
  ...
  const getEmployeeScheduleData = useMemo(() => {
    ...
    return Object.entries(staffShiftsGrouped.data)
            ...
            <div className="w-64 flex-shrink-0 p-4 bg-gray-50">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium">
                  Work Schedule - {dayjs(selectedDate).format('DD/MM/YYYY')}
                </span>
              </div>
            </div>
            <div
              className="flex-1 relative"
              style={{ minWidth: `${24 * 40}px` }}
            >
              <div className="flex">
                        ...
                        >
                          ...
                          <div className="relative h-full py-2">
                            {employee.shifts.map((shift, shiftIndex) => {
                              ...
                              const statusStyle = getShiftStatusStyle(
                                shift.shiftStatus
                              );
