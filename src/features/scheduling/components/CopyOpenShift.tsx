...
import { useCopyScheduledShiftsWeek, CopyWeekRequestDto } from '@/api/v1/scheduled-shift';
...
export function CopyOpenShift({ open, onOpenChange }: CopyOpenShiftProps) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            error('Copy Failed', err.response?.data?.message || 'Failed to copy open scheduled shifts');
        }
    };
            ...
            <DialogContent className="max-w-5xl max-h-[95vh] overflow-hidden flex flex-col">
                <DialogHeader className="pb-6 border-b">
                    <DialogTitle className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold text-foreground">Copy Open Shifts</h1>
                            <p className="text-base text-muted-foreground mt-1">
                                {step === 'select' ? 'Select source and target weeks for copying shifts' : 'Confirm your copy operation'}
                            </p>
                        </div>
                    </DialogTitle>
                            ...
                            <Card className="border-2 border-primary/20 bg-primary/5">
                                <CardHeader className="pb-4">
                                    ...
                                    <CardDescription className="text-muted-foreground">
                                        Choose any date from the week that contains the shifts you want to copy
                                    </CardDescription>
                                </CardHeader>
                                        ...
                                        <div className="flex items-start gap-2">
                                            ...
                                            <div className="text-sm text-foreground">
                                                ...
                                                <ul className="list-disc list-inside space-y-1 text-xs text-muted-foreground">
                                                    <li>Existing shifts in target weeks will be skipped automatically</li>
                                                    <li>Only shifts from the source week will be copied</li>
