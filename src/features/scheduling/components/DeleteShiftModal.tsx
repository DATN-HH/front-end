          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <DialogDescription className="mt-1">
                ...
                shift and remove all associated data.
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
              ...
              {shift.requirements && shift.requirements.length > 0 && (
                <div className="flex flex-wrap items-center gap-1.5">
                  {shift.requirements.map((req, index) => (
                    <div
                      key={index}
                      className="flex items-center gap-1 px-2 py-1 bg-muted text-muted-foreground rounded-md text-xs"
                    >
                      <span>{req.role}</span>
          ...
          <div className="mt-4 p-3 bg-destructive/10 border border-destructive/20 rounded-lg">
            <div className="flex items-start gap-2">
              ...
              <div className="text-sm text-destructive">
                ...
                <p>
                  All scheduled shifts using this template will be affected.
                </p>
              </div>
            </div>
          </div>
