        ...
        try {
            ...
            error(
                ...
                err.response?.data?.message ||
                    'Failed to copy week with schedule'
            );
        }
    };
                            ...
                            <Card className="border-2 border-primary/20 bg-primary/5">
                                <CardHeader className="pb-4">
                                    ...
                                    <CardDescription className="text-muted-foreground">
                                        Choose any date from the week that
                                        contains the complete schedule you want
                                        to copy (including staff assignments)
                                    </CardDescription>
                                </CardHeader>
                                ...
                                <CardHeader className="pb-4">
                                    <div className="flex items-center justify-between">
                                        <div>
                                            ...
                                            <CardDescription className="text-muted-foreground">
                                                Choose the weeks where you want
                                                to copy the complete schedule to
                                            </CardDescription>
                                        </div>
                                        <Badge
                                            variant="outline"
                            ...
                            <Card className="border-2 border-accent/50 bg-accent/10">
                                <CardHeader className="pb-4">
                                    ...
                                    <CardDescription className="text-muted-foreground">
                                        ...
                                        proceeding. This action will copy the
                                            ...
                                            <div className="text-sm text-foreground">
                                                ...
                                                <ul className="list-disc list-inside space-y-1 text-xs text-muted-foreground">
                                                    <li>
                                                        ...
                                                        staff assignments from
                                                        the source week
                                                    </li>
                                                    <li>
                                                        Existing staff
                                                        assignments in target
