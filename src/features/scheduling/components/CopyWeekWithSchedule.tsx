...
import {
  useCopyWeekWithSchedule,
  CopyWeekWithScheduleRequestDto,
} from '@/api/v1/staff-shifts';
...
export function CopyWeekWithSchedule({
  open,
  onOpenChange,
}: CopyWeekWithScheduleProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      success('Week Schedule Copied Successfully! 🎉', result.message);

      handleClose();
    } catch (err: any) {
      error(
        'Copy Failed',
        err.response?.data?.message || 'Failed to copy week with schedule'
      );
    }
  };
          ...
          <DialogTitle className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-foreground">
                Copy Week with Schedule
              </h1>
              <p className="text-base text-muted-foreground mt-1">
                {step === 'select'
                  ? 'Select source and target weeks for copying complete schedules'
              ...
              <Card className="border-2 border-primary/20 bg-primary/5">
                <CardHeader className="pb-4">
                  ...
                  <CardDescription className="text-muted-foreground">
                    Choose any date from the week that contains the complete
                    schedule you want to copy (including staff assignments)
                  </CardDescription>
                </CardHeader>
                      ...
                      <div className="flex items-start gap-2">
                        ...
                        <div className="text-sm text-foreground">
                          ...
                          <ul className="list-disc list-inside space-y-1 text-xs text-muted-foreground">
                            ...
                            <li>
                              Existing staff assignments in target weeks will be
                              replaced
                            </li>
                          </ul>
                        </div>
                ...
                <CardHeader className="pb-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <CardDescription className="text-muted-foreground">
                        Choose the weeks where you want to copy the complete
                        schedule to
                      </CardDescription>
                    </div>
            ...
            <div className="space-y-6">
              ...
              <Card className="border-2 border-accent/50 bg-accent/10">
                <CardHeader className="pb-4">
                  ...
                  <CardDescription className="text-muted-foreground">
                    Please review the details before proceeding. This action
                    will copy the complete weekly schedule.
                  </CardDescription>
                </CardHeader>
                  ...
                  <div className="mt-6 p-4 bg-muted/50 border border-muted rounded-lg">
                    <div className="flex items-start gap-2">
                      ...
                      <div className="text-sm text-foreground">
                        ...
                        <ul className="list-disc list-inside space-y-1 text-xs text-muted-foreground">
                          <li>
                            This will copy ALL scheduled shifts and staff
                            assignments from the source week
                          </li>
                          <li>
                            Existing staff assignments in target weeks will be
                            DELETED first
                          ...
                          <li>
                            Staff will receive notifications about schedule
                            changes
                          </li>
                        </ul>
                      </div>
