...
export function ShiftAssignmentSuggestions({
    ...
    const handleGenerateSchedule = async () => {
        ...
        const request: CompleteScheduleRequest = {
            ...
            excludeStaffIds:
                excludeStaffIds.length > 0 ? excludeStaffIds : undefined,
        };
    ...
    const handleBulkAssignRole = async (
        ...
        if (suggestedStaff.length === 0) {
            error(
                'No Suggestions',
                'No suggested staff to assign for this role'
            );
            return;
        }
        ...
        try {
            ...
            error(
                ...
                err.response?.data?.message ||
                    'Failed to assign suggested staff'
            );
        }
    };
    ...
    const handleBulkAssignAllSuggestions = async () => {
        ...
        try {
            ...
            error(
                'Bulk Assignment Failed',
                err.response?.data?.message ||
                    'Failed to assign all suggested staff'
            );
        }
    };
                    ...
                    <DialogTitle className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-base text-muted-foreground mt-1">
                                View existing assignments and get suggestions
                                for missing staff positions
                            </p>
                        </div>
                    </DialogTitle>
                </DialogHeader>
                                ...
                                <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
                                    ...
                                    <div className="text-center p-3 bg-white rounded border">
                                        <div className="text-xl font-bold text-blue-600">
                                            {schedule.summary.scheduleCompleteness.toFixed(
                                                1
                                            )}
                                            %
                                        </div>
                            ...
                            <CardContent className="pt-12 pb-12">
                                <div className="text-center text-muted-foreground">
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        Select a week and click "Generate
                                        Schedule" to view assignments and
                                        suggestions
                                    </p>
                                </div>
                            </CardContent>
