...
export function ScheduleLockManager({
    ...
    const {
        ...
        isLoading,
        refetch,
    } = useBranchScheduleLocks(branchId!);
    ...
    const handleUnlockSubmit = async () => {
        if (!selectedLockId) {
            error(
                'Validation Error',
                'Please select a schedule lock to unlock'
            );
            return;
        }
        ...
        try {
            ...
            success(
                'Schedule Unlocked',
                'Schedule has been unlocked successfully'
            );
    ...
    const activeLocks =
        locks?.filter(
            (lock) => lock.lockStatus === ScheduleLockStatus.LOCKED
        ) || [];
    const lockHistory =
        locks?.filter(
            (lock) => lock.lockStatus !== ScheduleLockStatus.LOCKED
                            ...
                            <Card className="border-2 border-primary/20 bg-primary/5">
                                <CardHeader className="pb-4">
                                    ...
                                    <CardDescription className="text-muted-foreground">
                                        Lock a schedule for a specific date
                                        range to prevent modifications
                                    </CardDescription>
                                </CardHeader>
                                        ...
                                        <div className="text-sm text-destructive">
                                            ...
                                            <ul className="space-y-2 text-sm">
                                                <li className="flex items-start gap-2">
                                                    ...
                                                    <span>
                                                        Locked schedules cannot
                                                        be modified by staff or
                                                        managers
                                                    </span>
                                                </li>
                                                <li className="flex items-start gap-2">
                                ...
                                <>
                                    ...
                                    <Card>
                                        <CardHeader>
                                            ...
                                            <CardDescription>
                                                Currently locked schedules that
                                                can be unlocked
                                            </CardDescription>
                                        </CardHeader>
                                        <CardContent>
                        ...
                        <div className="space-y-6">
                            ...
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Check if a specific date is locked and
                                        view active lock details
                                    </CardDescription>
                                </CardHeader>
                                <CardContent className="space-y-4">
                                    <div className="space-y-2">
                                                        ...
                                                        <div className="space-y-2">
                                                            ...
                                                            <div className="flex items-center gap-2">
                                                                ...
                                                                <span>
                                                                    Locked by:{' '}
                                                                    {
                                                                        activeLockForDate.lockedByName
                                                                    }
                                                                </span>
                                                            </div>
                                                            <div className="flex items-center gap-2">
                            ...
                            <Card>
                                <CardHeader>
                                    ...
                                    <CardDescription>
                                        Find all locks within a specific date
                                        range
                                    </CardDescription>
                                </CardHeader>
                                <CardContent className="space-y-4">
