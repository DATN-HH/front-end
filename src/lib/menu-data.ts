...
export const menuItems: MenuItem[] = [
  ...
  // Main Courses
  {
    ...
    price: 24.99,
    image: "/placeholder.svg?height=200&width=300&query=grilled salmon with vegetables",
  ...
  },
  {
    ...
    price: 32.99,
    image: "/placeholder.svg?height=200&width=300&query=ribeye steak with mashed potatoes",
    category: "Main Courses",
  },
  {
    id: "6",
    ...
    price: 19.99,
    image: "/placeholder.svg?height=200&width=300&query=chicken parmesan with pasta",
    category: "Main Courses",
  },
  {
    id: "7",
    ...
    price: 16.99,
    originalPrice: 19.99,
    image: "/placeholder.svg?height=200&width=300&query=vegetarian pasta with pesto",
    category: "Main Courses",
    isPromotion: true,
  ...
  // Burgers
  {
    ...
    price: 16.99,
    image: "/placeholder.svg?height=200&width=300&query=classic beef burger with fries",
    category: "Burgers",
    isBestSeller: true,
  },
  {
  ...
  },
  {
    ...
    price: 15.99,
    image: "/placeholder.svg?height=200&width=300&query=veggie burger with avocado",
    category: "Burgers",
  },
  ...
  // Desserts
  {
    ...
    price: 8.99,
    image: "/placeholder.svg?height=200&width=300&query=chocolate lava cake with ice cream",
    category: "Desserts",
    isBestSeller: true,
  },
  {
  ...
  // Combos
  {
    ...
    price: 49.99,
    originalPrice: 65.99,
    image: "/placeholder.svg?height=200&width=300&query=family feast combo meal",
    category: "Combos",
    isCombo: true,
    comboItems: [
  ...
  },
  {
    ...
    price: 39.99,
    originalPrice: 49.98,
    image: "/placeholder.svg?height=200&width=300&query=romantic dinner for two",
    category: "Combos",
    isCombo: true,
    comboItems: [
...
export const categories = ["All", "Appetizers", "Main Courses", "Burgers", "Desserts", "Combos"]
