      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-300 mb-6">
              Elevating fine dining experiences across the nation. Where culinary artistry meets exceptional service.
            </p>
          ...
          {/* Policies */}
          <div>
            <h4 className="text-lg font-serif font-semibold mb-4">Policies & Info</h4>
            <ul className="space-y-2">
              {policies.map((policy) => (
                <li key={policy.name}>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-white font-medium">+1 (800) MENU-PLUS</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-white font-medium">info@menuplus.com</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <h4 className="text-xl font-serif font-semibold mb-6 text-center">Our Locations</h4>
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 Menu+ Fine Dining. All rights reserved. | Designed for exceptional experiences.
            </p>
            <div className="flex items-center gap-4 mt-4 md:mt-0">
              <span className="text-gray-400 text-sm">Powered by culinary excellence</span>
            </div>
          </div>
        </div>
      </div>
