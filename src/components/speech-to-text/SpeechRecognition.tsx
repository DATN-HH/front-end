            ...
            recognition.onend = () => {
                ...
                if (finalTranscript.trim()) {
                    ...
                    try {
                        ...
                        console.error('Error resetting recognition instance:', e);
                    }
                    try {
        ...
        <>
            <Button
                ...
                className={`transition-all duration-300 ${
                    isListening ? 'text-red-500 animate-pulse ring-2 ring-red-500 ring-opacity-50' : 
                    permissionDenied ? 'text-red-500 bg-red-50 dark:bg-red-900 dark:bg-opacity-20' : 
                    networkError ? 'text-amber-500 bg-amber-50 dark:bg-amber-900 dark:bg-opacity-20' : ''
                }`}
