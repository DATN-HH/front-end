...
export function ProductAttributeCreateModal({ open, onOpenChange }: ProductAttributeCreateModalProps) {
    ...
    const addValue = () => {
        ...
        if (attributeValues.some(v => v.name.toLowerCase() === newValue.name.toLowerCase())) {
            toast({
                title: 'Validation Error',
        ...
        <Dialog open={open} onOpenChange={handleClose}>
            <DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Create a new product attribute that can be used to define product variants.
                    </DialogDescription>
                </DialogHeader>
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>Define the basic properties of the attribute</CardDescription>
                            </CardHeader>
                            ...
                            <CardContent className="space-y-4">
                                ...
                                {attributeValues.length > 0 && (
                                    <div className="space-y-2">
                                        <label className="text-sm font-medium">Added Values ({attributeValues.length})</label>
                        ...
                        <div className="flex items-center space-x-2">
                            <Checkbox
                                id="saveAndNew"
                                checked={saveAndNew}
                                onCheckedChange={(checked) => setSaveAndNew(checked === true)}
                            />
                            <label
                                htmlFor="saveAndNew"
