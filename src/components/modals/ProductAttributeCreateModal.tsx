    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Create a new product attribute that can be used to define product
            variants.
          </DialogDescription>
        </DialogHeader>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        When product variants should be created for this
                        attribute
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
            ...
            {displayType !== 'TEXTBOX' && (
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Add possible values for this attribute (not needed for
                    textbox type)
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
