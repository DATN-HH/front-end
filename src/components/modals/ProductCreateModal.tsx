    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Add a new product to your menu. Fill in the information across the
            different tabs.
          </DialogDescription>
        </DialogHeader>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>
                            If no category is selected, the product will be
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          Group related products together for better
                          organization
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mb-4">
                      Upload a high-quality image of your product. Supported
                      ...
                      render={({ field }) => (
                        <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                          ...
                          <div className="space-y-1 leading-none">
                            ...
                            <FormDescription>
                              Enable if this product can be purchased from
                              suppliers
                            </FormDescription>
                          </div>
                        </FormItem>
            ...
            <div className="flex justify-end space-x-2 pt-4 border-t">
              ...
              <Button
                ...
                disabled={createProductMutation.isPending || uploadingImage}
              >
                {(createProductMutation.isPending || uploadingImage) &&
                saveAndNew ? (
